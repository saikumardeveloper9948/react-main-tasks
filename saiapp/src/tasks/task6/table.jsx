             ...
             <div> 
              <table >
                ...
                {obj.map((a)=>{
                  return (
                    <tr style={{border:"2px solid black"}}>
                    <td style={{border:"2px solid black"}}>{a.id}</td>
                    <td style={{border:"2px solid black"}}>{a.title}</td>
                    <td style={{border:"2px solid black"}}>{a.category}</td>
                    <td style={{border:"2px solid black"}}>{a.description}</td>
                    <td style={{border:"2px solid black"}}>{a.rating.rate}</td>
                    <td style={{border:"2px solid black"}}>{a.price}</td>
                    <td style={{border:"2px solid black"}}><img style={{width:'150px'}} src={a.image} alt="items" ></img></td>
                </tr>
                  )
                })}
              </table>
